  ...
  return (
    <>
      ...
      <section className="content-grid">
        <div className="panel">
          <div className="panel-head"><div><h2>Pengeluaran Mingguan</h2></div><span className="badge">Data Statis</span></div>
          <div className="bars">
            {days.map((d, i) => (
        ...
        <div className="panel">
          <div className="panel-head"><div><h2>Kategori Teratas</h2></div><span className="badge">{topCatName}</span></div>
